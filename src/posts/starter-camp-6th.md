...
![liaoyufei](../images/starter-camp-6th/liaoyufei.jpg)
...
![liaoyufei](../images/starter-camp-6th/xierunming.jpg)
...
<MessageBox>
   <Message name="杨晓春" github="Le-soleile">
    上大学之后了解和使用过一些飞桨的工具和平台，对 AI Infra 方向很感兴趣，今年在学长推荐下了解了飞桨的启航计划开源活动。在本次启航计划中，我主要参与了 PaddlePaddle 框架的底层与生态建设工作。包括 CUDA 算子库的规范化治理，提升了算子代码的可维护性与标准化水平，完成了 PaddleMaterials 的数据适配工作，优化了数据加载与处理流程。接下来我会继续参与护航计划，进行 API 接口适配工作，致力于提升框架的兼容性与易用性。<br>
    这是我第一次参与开源项目，总体感觉就是导师们很包容、很热心、很厉害，同时也能增强自己的能力，学习到一些简单的开发必要流程和知识，希望有更多同学参与到飞桨的AI基建中。

![liaoyufei](../images/starter-camp-6th/yangxiaochun.jpg)
...
![yeung](../images/starter-camp-6th/yeung.jpg)
